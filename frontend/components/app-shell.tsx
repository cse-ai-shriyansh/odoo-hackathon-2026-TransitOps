...
import { BarChart3, Bell, ChevronDown, LogOut, Menu, MoonStar, SunMedium, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground">
      {mobileNavOpen ? (
        <div className="fixed inset-0 z-40 bg-background/80 backdrop-blur lg:hidden">
          <div className="h-full w-80 border-r border-border bg-background p-4">
          ...
          <header className="sticky top-4 z-30 rounded-2xl border border-border/80 bg-background/95 px-4 py-3 shadow-soft backdrop-blur">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 lg:hidden">
                <Button variant="ghost" className="h-10 w-10 p-0" onClick={() => setMobileNavOpen(true)} aria-label="Open navigation">
