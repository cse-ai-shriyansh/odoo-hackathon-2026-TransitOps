...
export default function LoginPage(): JSX.Element {
  ...
  return (
    <div className="grid min-h-screen bg-background lg:grid-cols-[1.1fr_0.9fr]">
      <section className="hidden border-r border-border bg-foreground p-10 text-background lg:flex lg:flex-col lg:justify-between">
        <div className="max-w-xl">
          <div className="mb-10 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-background/70">Smart fleet operations</p>
            </div>
          </div>
          <h1 className="max-w-lg text-5xl font-semibold tracking-tight">Operations control for modern transport teams.</h1>
          <p className="mt-6 max-w-lg text-base leading-7 text-background/75">
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            {Object.values(ROLE_LABELS).map((label) => (
              <Badge key={label} className="border border-background/20 bg-background text-foreground">
                {label}
              </Badge>
            ))}
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            ...
            <Card key={title} className="border-background/10 bg-background text-foreground backdrop-blur">
              <CardHeader>
      ...
      <section className="flex items-center justify-center p-6">
        <Card className="w-full max-w-xl border-border/80 bg-card shadow-2xl backdrop-blur">
          <CardHeader>
